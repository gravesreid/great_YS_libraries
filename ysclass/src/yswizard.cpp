...
char *YsWizard::ClassName="YsWizard";



// Implementation //////////////////////////////////////////
char *YsCollisionOfPolygon::ClassName="YsCollisionOfPolygon";
...
void YsCollisionOfPolygon::SetPolygon1(int nv1,const YsVec3 v1[])
{
	YsVec3 nom;
...
void YsCollisionOfPolygon::SetPolygon1(int nv1,const YsVec3 v1[],const YsVec3 &nom1)
{
	if(nv1>0)
	{
		np1=nv1;
...
void YsCollisionOfPolygon::SetPolygon2(int nv2,const YsVec3 v2[])
{
	YsVec3 nom;
...
void YsCollisionOfPolygon::SetPolygon2(int nv2,const YsVec3 v2[],const YsVec3 &nom2)
{
	if(nv2>0)
	{
		np2=nv2;
...
// Implementation //////////////////////////////////////////
char *YsBoundingBoxMaker2::ClassName="YsBoundingBoxMaker2";
...
void YsBoundingBoxMaker2::Make(int n,const YsVec2 v[])
{
	if(n>0)
	{
		int i;
...
// Implementation //////////////////////////////////////////
char *YsBoundingBoxMaker3::ClassName="YsBoundingBoxMaker3";
...
void YsBoundingBoxMaker3::Make(int n,const YsVec3 v[])
{
	if(n>0)
	{
		int i;
...
void YsBoundingBoxMaker3::Make(const YsArray <YsVec3> &ary)
{
	if(ary.GetNumItem()>0)
	{
		Begin(ary.GetItem(0));
...
void YsBoundingBoxMaker3::Make(const YsShell &shl,int nVt,const YsShellVertexHandle vtHd[])
{
	int i;
	YsVec3 pos;
	Begin();
...
YSRESULT YsTraceLineSegment::SetLineSegment(int np,const YsVec3 p[],YSBOOL islp)
{
	lSeg.Set(np,p);
	isLoop=islp;
	if(islp==YSTRUE)
