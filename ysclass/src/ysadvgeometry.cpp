...
YSBOOL YsCheckConvex2(int np,const YsVec2 p[],YSBOOL strictCheck)
{
	...
	else
	{
		...
		if(YsCheckConvexByAngle2(np,p)==YSTRUE)
		{
			for(i=0; i<np; i++)
			{
				...
				z=(p[idx1]-p[idx0])^(p[idx2]-p[idx1]);

				if(YsAbs(z)<YsTolerance)    // Modified 2000/11/10
				{
					continue;
				}
...
YSBOOL YsCheckConvex3(int np,const YsVec3 p[],YSBOOL strictCheck)
{
	if(strictCheck!=YSTRUE)
	{
...
YSSIDE YsCheckInsidePolygon2(const YsVec2 &pnt,int np,const YsVec2 p[])
{
	if(np==3)                                    // 2009/03/30
	{                                            // 2009/03/30
...
(int np,const YsVec3 p[],const YsPlane &pln,const YsVec3 &e1,const YsVec3 &e2)
{
	if(e1!=e2 &&
...
YSINTERSECTION YsGetPolygonPenetration_CheckObviousIntersection1to2
    (int &nTouch,int np1,const YsVec3 p1[],const YsPlane &pln1,int np2,const YsVec3 p2[])
{
...
YSBOOL YsGetPolygonPenetration_CheckAllVtxOfPolyg1IsOneSideOfPolyg2
    (YSBOOL &side1,YSBOOL &side2,int np1,const YsVec3 p1[],const YsPlane &pln2)
{
	int i;
...
YSBOOL YsGetPolygonPenetration_Overlapping(int np1,const YsVec3 p1[],int np2,const YsVec3 p2[])
{
	int i,j;
...
YSBOOL YsGetPolygonPenetration_ExhaustiveCheckIntersectionPolyg1To2
    (int np1,const YsVec3 p1[],int np2,const YsVec3 p2[],const YsPlane &pln2)
{
	int i;
...
YSINTERSECTION YsGetPolygonPenetration
    (int np1,const YsVec3 p1[],int np2,const YsVec3 p2[])
{
	YsPlane pln1,pln2;
...
YSRESULT YsGetArbitraryInsidePointOfPolygon2
     (YsVec2 &aip,int np,const YsVec2 p[],YSBOOL strictConvexityCheck)
{
...
YSRESULT YsGetArbitraryInsidePointOfPolygon3
  (YsVec3 &aip,int np,const YsVec3 p[],YSBOOL strictConvexityCheck)
{
...
YSRESULT YsSortPointSet3(YsVec3 p[],int idx[],int np,const YsVec3 refp,double sqKnownMaxDistance)
{
...
YSRESULT YsGetNearestPointOnLineSegments3
   (YsVec3 &nearPos,int &nearIdx,YSBOOL &nearNode,int np,const YsVec3 p[],const YsVec3 &refp)
{
	double nearNodeDistSq,nearEdgeDistSq;
...
YSRESULT YsGetTangentialVectorAtNodeOfLineSegments3(YsVec3 &unitTan,int ndId,int np,const YsVec3 p[])
{
	if(0<=ndId && ndId<np)
	{
		int i;
...
YSRESULT YsFindLeastSquareFittingPlane(double &aa,double &bb,double &cc,double &dd,int nVtx,const YsVec3 vtx[])
{
	// ax+by+cz+d=0
	double a,b,c,d,l;
	int i,j,nSol;
